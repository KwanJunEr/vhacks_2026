...
import { MissionGanttChart } from "@/components/dashboard/MissionGanttChart";
import { AICoordinationTrend } from "@/components/dashboard/AICoordinationTrend";
import { ActiveFleetManagement } from "@/components/dashboard/ActiveFleetManagement";
                ...
                <div
                  className={cn(
                    ...
                    simState === "detecting"
                      ...
                      : "bg-red-50/95 border-red-200 ring-4 ring-red-100",
                  )}
                >
                  {/* Header */}
                  <div
                    ...
                    {simState === "detecting" ? (
                      <div className="flex flex-col items-center gap-4 py-4 text-center">
                        ...
                        <p className="text-sm font-medium text-slate-600">
                          Analyzing global sensor array for waveform
                          confirmation...
                        </p>
                      </div>
                    ) : (
                        ...
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-red-100/50 border border-red-200">
                          ...
                          <div>
                            <p className="text-sm font-bold text-red-900">
                              Magnitude 6.2 Detected
                            </p>
                            <p className="text-xs text-red-700 font-medium">
                              Confirmation: High Confidence (98%)
                            </p>
                          </div>
                        </div>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-900">
                        Earthquake Detected in Sabah
                      </p>
                      <p className="text-xs text-red-600 font-semibold mb-1">
                        Region: Ranau District
                      </p>
                      <p className="text-[10px] text-slate-500 uppercase tracking-wide">
                        Automated Alert • Just Now
                      </p>
                    </div>
                  </motion.div>
                )}
