    ...
    const fetchDrones = async () => {
      ...
      const mockDrones: DroneData[] = [
        ...
        },
        {
          ...
          "max_load(kg)": 5.0,
          image_url:
            "https://images.unsplash.com/photo-1524143902223-93f037e9623e?q=80&w=400&auto=format&fit=crop",
        },
        {
          id: "3",
          drone_name: "Alpha-3",
        ...
        },
        {
          ...
          "max_load(kg)": 5.0,
          image_url:
            "https://images.unsplash.com/photo-1506947411487-a56738267384?q=80&w=400&auto=format&fit=crop",
        },
      ];
    ...
    <div className="container mx-auto py-10 px-4">
      <div className="mb-10 text-center">
        ...
        <p className="text-muted-foreground">
          View and manage all drones currently in your drone fleet
        </p>
      </div>
          ...
          {drones.length > 0 ? (
                ...
                <Sheet>
                    ...
                    <Card className="overflow-hidden cursor-pointer border-2 hover:border-primary transition-all duration-300 h-full flex flex-col group">
                      ...
                      <CardHeader className="pb-2">
                        <div className="flex justify-between items-start">
                          ...
                          <div
                            className={`flex items-center gap-1 font-bold ${getBatteryColor(drone.battery)}`}
                          >
                  ...
                  <SheetContent side="right" className="sm:max-w-md">
                    <SheetHeader className="text-left">
                      ...
                      <Badge
                        className={`${getStatusColor(drone.status)} text-white w-fit px-4 py-1 mb-6`}
                      >
                        {drone.status.toUpperCase()}
                      </Badge>
                    </SheetHeader>
                    ...
                    <div className="space-y-6 mt-6">
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        <div className="flex items-center gap-4 p-4 rounded-xl bg-muted/50">
                          <Battery
                            className={`w-6 h-6 ${getBatteryColor(drone.battery)}`}
                          />
                          <div>
            ...
            <div className="col-span-full text-center py-20">
              ...
              <p className="text-muted-foreground mb-6">
                Your fleet is currently empty. Add drones to your Supabase
